    ...
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} viewport={{ once: true }}>
            ...
            <div className="contact-link-container">
                ...
                <a className=" contact-link resume" href="https://drive.google.com/file/d/17arArLuVOBXR-AkYvoZ8Uf2HZRpU7voS/view" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFileLines} /></a>
            </div>
